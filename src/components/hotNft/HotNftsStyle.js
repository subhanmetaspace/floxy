...
export const TextPayment = styled.div`
  ...
  background-image: linear-gradient(to bottom, #181818, #000, #3c15a7, #9173e0),
    linear-gradient(to top, #181818, #181818),
...
export const TextWallet = styled.div`
  ...
  border-image-slice: 1;
  background-image: linear-gradient(to top, #000, #000, #3c15a7, #9173e0),
...
export const TextTravel = styled.div`
  ...
  border: 1px solid #3a57b55c;
  border-image-slice: 1;
  background-image: linear-gradient(to bottom, #000, #000, #3c15a7, #9173e0),
    linear-gradient(to top, #181818, #181818),
    linear-gradient(to top, #3a57b5, #9e5ae6);
  background-origin: border-box;
  @media (max-width: 500px) {
...
export const TextParagraph = styled.div`
  background-image: linear-gradient(to right, #777, #fff),
    linear-gradient(to left, #5a5a5a, #5a5a5a);
  font-family: Lato;
  font-size: 24px;
  font-weight: bold;
  color: #5a5a5a;
...
export const TextWeb = styled.div`
  ...
  border-image-slice: 1;
  background-image: linear-gradient(to left, #19243afa, #07193a),
    linear-gradient(to right, #181818, #181818),
    linear-gradient(to top, #3a57b5, #9e5ae6);
  background-origin: border-box;
  background-clip: content-box, content-box, border-box;
  position: absolute;
